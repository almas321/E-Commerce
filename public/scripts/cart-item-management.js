const cartItemUpdateFormElements = document.querySelectorAll('.cart-item-management');  //update button
...
const cartBadgeElements = document.querySelectorAll('.nav-items .badge');  //because two badge one mobile screen one big screen
  ...
  async function updateCartItem(event) {
    ...
    // I don't want to let the browser do that. Instead I want to send my own JavaScripted driven HTTP request so that we don't force a page reload. Instead we stay on the page
